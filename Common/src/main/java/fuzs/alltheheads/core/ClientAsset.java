...
public interface ClientAsset {
    ...
    public record ResourceTexture(ResourceLocation id, ResourceLocation texturePath) implements ClientAsset.Texture {
        public static final Codec<ClientAsset.ResourceTexture> CODEC = ResourceLocation.CODEC.xmap(ClientAsset.ResourceTexture::new,
        ...
        public static final StreamCodec<ByteBuf, ClientAsset.ResourceTexture> STREAM_CODEC = ResourceLocation.STREAM_CODEC.map(
                ClientAsset.ResourceTexture::new,
                ClientAsset.ResourceTexture::id);

...
public class PandaHeadType {
    ...
    public static void bootstrap(BootstrapContext<HeadType> context) {
        ...
        bootstrapPanda(context, Panda.Gene.BROWN, BROWN_PANDA, "entity/panda/panda_brown", SoundEvents.PANDA_AMBIENT);
        bootstrapPanda(context, Panda.Gene.LAZY, LAZY_PANDA, "entity/panda/panda_lazy", SoundEvents.PANDA_AMBIENT);
        ...
        bootstrapPanda(context, Panda.Gene.WEAK, WEAK_PANDA, "entity/panda/panda_weak", SoundEvents.PANDA_SNEEZE);
        bootstrapPanda(context,
                Panda.Gene.WORRIED,
                WORRIED_PANDA,

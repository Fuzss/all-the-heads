...
public class RabbitHeadType {
    ...
    public static void bootstrap(BootstrapContext<HeadType> context) {
        bootstrapRabbit(context, Rabbit.Variant.BROWN, BROWN_RABBIT, "entity/rabbit/rabbit_brown");
        bootstrapRabbit(context, Rabbit.Variant.WHITE, WHITE_RABBIT, "entity/rabbit/rabbit_white");
        bootstrapRabbit(context, Rabbit.Variant.BLACK, BLACK_RABBIT, "entity/rabbit/rabbit_black");
        bootstrapRabbit(context,
                Rabbit.Variant.WHITE_SPLOTCHED,
                WHITE_SPLOTCHED_RABBIT,
                "entity/rabbit/rabbit_white_splotched");
        bootstrapRabbit(context, Rabbit.Variant.GOLD, GOLD_RABBIT, "entity/rabbit/rabbit_gold");
        bootstrapRabbit(context, Rabbit.Variant.SALT, SALT_RABBIT, "entity/rabbit/rabbit_salt");
        bootstrapRabbit(context,
                Rabbit.Variant.EVIL,
                EVIL_RABBIT,

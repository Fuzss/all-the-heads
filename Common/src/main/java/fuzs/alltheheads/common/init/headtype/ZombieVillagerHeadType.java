...
public class ZombieVillagerHeadType {
    ...
    public static void bootstrapLootItemConditions(BootstrapContext<LootItemCondition> context) {
        // Desert Zombie Villagers
        bootstrapLootItemCondition(context, VillagerType.DESERT, DESERT_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                VillagerType.DESERT,
                VillagerProfession.CLERIC,
                DESERT_CLERIC_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.DESERT,
                VillagerProfession.FARMER,
                DESERT_FARMER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.DESERT,
                VillagerProfession.FISHERMAN,
                DESERT_FISHERMAN_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                ...
                DESERT_MASON_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.DESERT,
                VillagerProfession.NITWIT,
                DESERT_NITWIT_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.DESERT,
                VillagerProfession.SHEPHERD,
                DESERT_SHEPHERD_ZOMBIE_VILLAGER);
        ...
        // Jungle Zombie Villagers
        bootstrapLootItemCondition(context, VillagerType.JUNGLE, JUNGLE_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.JUNGLE,
                VillagerProfession.ARMORER,
                JUNGLE_ARMORER_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                VillagerType.JUNGLE,
                VillagerProfession.CLERIC,
                JUNGLE_CLERIC_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.JUNGLE,
                VillagerProfession.FARMER,
                JUNGLE_FARMER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.JUNGLE,
                VillagerProfession.FISHERMAN,
                JUNGLE_FISHERMAN_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                VillagerType.JUNGLE,
                VillagerProfession.MASON,
                JUNGLE_MASON_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.JUNGLE,
                VillagerProfession.NITWIT,
                JUNGLE_NITWIT_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.JUNGLE,
                VillagerProfession.SHEPHERD,
                JUNGLE_SHEPHERD_ZOMBIE_VILLAGER);
        ...
        // Plains Zombie Villagers
        bootstrapLootItemCondition(context, VillagerType.PLAINS, PLAINS_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.PLAINS,
                VillagerProfession.ARMORER,
                PLAINS_ARMORER_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                VillagerType.PLAINS,
                VillagerProfession.CLERIC,
                PLAINS_CLERIC_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.PLAINS,
                VillagerProfession.FARMER,
                PLAINS_FARMER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.PLAINS,
                VillagerProfession.FISHERMAN,
                PLAINS_FISHERMAN_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                VillagerType.PLAINS,
                VillagerProfession.MASON,
                PLAINS_MASON_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.PLAINS,
                VillagerProfession.NITWIT,
                PLAINS_NITWIT_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.PLAINS,
                VillagerProfession.SHEPHERD,
                PLAINS_SHEPHERD_ZOMBIE_VILLAGER);
        ...
        // Savanna Zombie Villagers
        bootstrapLootItemCondition(context, VillagerType.SAVANNA, SAVANNA_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SAVANNA,
                VillagerProfession.ARMORER,
                SAVANNA_ARMORER_ZOMBIE_VILLAGER);
        ...
        // Snow Zombie Villagers
        bootstrapLootItemCondition(context, VillagerType.SNOW, SNOW_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SNOW,
                VillagerProfession.ARMORER,
                SNOW_ARMORER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SNOW,
                VillagerProfession.BUTCHER,
                SNOW_BUTCHER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SNOW,
                VillagerProfession.CARTOGRAPHER,
                SNOW_CARTOGRAPHER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context, VillagerType.SNOW, VillagerProfession.CLERIC, SNOW_CLERIC_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context, VillagerType.SNOW, VillagerProfession.FARMER, SNOW_FARMER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SNOW,
                VillagerProfession.FISHERMAN,
                SNOW_FISHERMAN_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                ...
                VillagerProfession.LIBRARIAN,
                SNOW_LIBRARIAN_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context, VillagerType.SNOW, VillagerProfession.MASON, SNOW_MASON_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context, VillagerType.SNOW, VillagerProfession.NITWIT, SNOW_NITWIT_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SNOW,
                VillagerProfession.SHEPHERD,
                SNOW_SHEPHERD_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SNOW,
                VillagerProfession.TOOLSMITH,
                SNOW_TOOLSMITH_ZOMBIE_VILLAGER);
        ...
        // Swamp Zombie Villagers
        bootstrapLootItemCondition(context, VillagerType.SWAMP, SWAMP_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SWAMP,
                VillagerProfession.ARMORER,
                SWAMP_ARMORER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SWAMP,
                VillagerProfession.BUTCHER,
                SWAMP_BUTCHER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SWAMP,
                VillagerProfession.CARTOGRAPHER,
                SWAMP_CARTOGRAPHER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SWAMP,
                VillagerProfession.CLERIC,
                SWAMP_CLERIC_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SWAMP,
                VillagerProfession.FARMER,
                SWAMP_FARMER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SWAMP,
                VillagerProfession.FISHERMAN,
                SWAMP_FISHERMAN_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                ...
                VillagerProfession.LIBRARIAN,
                SWAMP_LIBRARIAN_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context, VillagerType.SWAMP, VillagerProfession.MASON, SWAMP_MASON_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SWAMP,
                VillagerProfession.NITWIT,
                SWAMP_NITWIT_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.SWAMP,
                VillagerProfession.SHEPHERD,
                SWAMP_SHEPHERD_ZOMBIE_VILLAGER);
        ...
        // Taiga Zombie Villagers
        bootstrapLootItemCondition(context, VillagerType.TAIGA, TAIGA_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.TAIGA,
                VillagerProfession.ARMORER,
                TAIGA_ARMORER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.TAIGA,
                VillagerProfession.BUTCHER,
                TAIGA_BUTCHER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.TAIGA,
                VillagerProfession.CARTOGRAPHER,
                TAIGA_CARTOGRAPHER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.TAIGA,
                VillagerProfession.CLERIC,
                TAIGA_CLERIC_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.TAIGA,
                VillagerProfession.FARMER,
                TAIGA_FARMER_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.TAIGA,
                VillagerProfession.FISHERMAN,
                TAIGA_FISHERMAN_ZOMBIE_VILLAGER);
        ...
        bootstrapLootItemCondition(context,
                ...
                VillagerProfession.LIBRARIAN,
                TAIGA_LIBRARIAN_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context, VillagerType.TAIGA, VillagerProfession.MASON, TAIGA_MASON_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.TAIGA,
                VillagerProfession.NITWIT,
                TAIGA_NITWIT_ZOMBIE_VILLAGER);
        bootstrapLootItemCondition(context,
                VillagerType.TAIGA,
                VillagerProfession.SHEPHERD,
                TAIGA_SHEPHERD_ZOMBIE_VILLAGER);
    ...
    private static void bootstrapLootItemCondition(BootstrapContext<LootItemCondition> context, ResourceKey<VillagerType> type, ResourceKey<HeadType> resourceKey) {
        bootstrap(context, resourceKey, EntityTypes.ZOMBIE_VILLAGER, (EntityPredicate.Builder builder) -> {

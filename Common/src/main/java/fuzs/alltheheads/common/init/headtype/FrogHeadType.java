...
public class FrogHeadType {
    ...
    public static void bootstrap(BootstrapContext<HeadType> context) {
        bootstrapFrog(context, FrogVariants.TEMPERATE, TEMPERATE_FROG, "entity/frog/frog_temperate");
        bootstrapFrog(context, FrogVariants.WARM, WARM_FROG, "entity/frog/frog_warm");
        bootstrapFrog(context, FrogVariants.COLD, COLD_FROG, "entity/frog/frog_cold");
    }

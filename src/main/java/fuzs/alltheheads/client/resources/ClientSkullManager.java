...
public class ClientSkullManager {
    ...
    private void dissolve() {
        if (this.clientDataBySkullType == null) {
            ...
            builders.add(new ClientSkullType.Builder("squid").textureLocation("textures/entity/squid/squid.png").modelOffsets(0.0F, -16.0F, 0.0F).customHeadKey("body"));
            builders.add(new ClientSkullType.Builder("axolotl#lucy").textureLocation("textures/entity/axolotl/axolotl_lucy.png").modelOffsets(5.0F, -3.0F, 0.0F).customHeadKey("body", "head"));
            builders.add(new ClientSkullType.Builder("axolotl#wild").textureLocation("textures/entity/axolotl/axolotl_wild.png").modelOffsets(0.0F, -3.0F, 5.0F).customHeadKey("body", "head"));
            builders.add(new ClientSkullType.Builder("axolotl#gold").textureLocation("textures/entity/axolotl/axolotl_gold.png").modelOffsets(-5.0F, -2.0F, 0.0F).customHeadKey("body", "head"));
